...
const principles = [
  ...
  },
  {
    ...
    body:
      "70% урока — практика речи. В группе на 30 человек ученик молчит и слушает; у нас каждый успевает 5–8 раз произнести фразу, услышать поправку и снова сказать. Для школьников строго с 12 лет доступен индивидуальный модуль на месяц: 8 занятий по 60 минут.",
    card: "card-lime-soft",
  },
];
...
const audiences = [
  {
    badge: "Подросткам 12+",
    body:
      "Школьники строго с 12 лет, которым нужен китайский для поступления, ОГЭ-сценариев или дополнительного языка. Индивидуальный модуль оплачивается за один месяц без подписки; следующий модуль приобретается отдельно.",
  },
  {
