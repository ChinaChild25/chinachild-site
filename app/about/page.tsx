...
export async function generateMetadata(): Promise<Metadata> {
  return buildMetadata({
    ...
    description:
      "Онлайн-школа китайского ChinaChild: лицензия Москвы, 4 преподавателя с опытом 7–13 лет, программа HSK 1–2 за 6 месяцев, налоговый вычет до 19 500 ₽.",
    path: "/about",
    keywords: [
      "о школе chinachild",
...
const principles = [
  ...
  },
  {
    ...
    body:
      "Школа работает по образовательной лицензии Департамента образования и науки Москвы. Программа дополнительного профессионального образования соответствует HSK 1–2. После курса выдаём документ — его прикладывают к заявлению на налоговый вычет 13% (до 19 500 ₽ в год).",
    card: "card-cream",
  },
  {
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Да. Школа работает по лицензии Департамента образования и науки Москвы, выдаёт документ о прохождении программы. Этот документ прикладывают к заявлению на налоговый вычет 13% — до 19 500 ₽ в год.",
      },
    },
  ],
};
