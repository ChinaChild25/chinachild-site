...
export async function generateMetadata(): Promise<Metadata> {
  return buildMetadata({
    ...
    description:
      "Онлайн-школа китайского ChinaChild: лицензия Москвы, 4 преподавателя с опытом 7–13 лет, программа HSK 1–2 за 6 месяцев. Налоговый вычет: до 19 500 ₽ за себя или до 14 300 ₽ за ребёнка.",
    path: "/about",
    keywords: [
      "о школе chinachild",
...
const principles = [
  ...
  },
  {
    ...
    body:
      "Школа работает по образовательной лицензии Департамента образования и науки Москвы. Программа дополнительного профессионального образования соответствует HSK 1–2. При наличии права на вычет можно вернуть до 19 500 ₽ за своё обучение или до 14 300 ₽ за обучение ребёнка.",
    card: "card-cream",
  },
  {
    ...
    body:
      "70% урока — практика речи. В группе на 30 человек ученик молчит и слушает; у нас каждый успевает 5–8 раз произнести фразу, услышать поправку и снова сказать. Для детей от 7 лет и подростков доступен индивидуальный модуль на месяц: 8 занятий по 60 минут.",
    card: "card-lime-soft",
  },
];
...
const audiences = [
  {
    badge: "Детям от 7 лет",
    body:
      "Дети от 7 лет и подростки, которым нужен китайский для поступления, ОГЭ-сценариев или дополнительного языка. Индивидуальный модуль оплачивается за один месяц без подписки; следующий модуль приобретается отдельно.",
  },
  {
...
const aboutSchema = {
  ...
  description:
    "ChinaChild — лицензированная онлайн-школа китайского языка для детей от 7 лет, подростков, студентов и взрослых. Программа HSK 1–2, мини-группы до 5 человек, своя обучающая платформа.",
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Школа работает по лицензии Департамента образования и науки Москвы и выдаёт документы для вычета. При наличии права можно вернуть до 19 500 ₽ за своё обучение или до 14 300 ₽ за обучение ребёнка; сумма зависит от расходов, уплаченного НДФЛ и законных лимитов.",
      },
    },
  ],
};
  ...
  return (
    <main>
      ...
      <PageHero
        ...
        description="Помогаем детям от 7 лет, подросткам, студентам и взрослым без подготовки выйти на разговорный китайский за 6 месяцев. Программа HSK 1–2 в реестре Москвы, своя обучающая платформа без Zoom и налоговый вычет 13% по итогам курса."
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-center">
            <div>
              ...
              <p className="mt-5 text-base leading-[1.65] text-[#4b4b4b]">
                ...
                13%. При наличии права можно вернуть до 19&nbsp;500 ₽ за своё
                обучение или до 14&nbsp;300 ₽ за обучение ребёнка; фактическая
                сумма зависит от расходов, уплаченного НДФЛ и законных лимитов.
              </p>
              <div className="mt-7 flex flex-wrap gap-3">
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-4 text-base leading-7 text-white/85">
                ...
                или работа. Заявки обрабатываем ежедневно с 09:00 до 21:00 по
                московскому времени, обычно отвечаем в течение 1–2 часов в этот
                период.
              </p>
            </div>
