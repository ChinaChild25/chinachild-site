...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "ChinaChild — онлайн-школа китайского языка с лицензированной программой HSK 1–2. Доступна из всех городов России: Москва, Санкт-Петербург, Казань, Екатеринбург, Новосибирск, Краснодар, Ростов-на-Дону, Владивосток.",
  path: "/cities",
  keywords: [
