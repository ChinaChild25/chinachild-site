...
export async function generateMetadata(): Promise<Metadata> {
  return buildMetadata({
    ...
    description:
      "Что получают ученики школы ChinaChild: разговорный уровень за 6 месяцев, сертификат HSK 2, мини-группы до 5 человек, налоговый вычет 13%. Реальные результаты и кейсы.",
    path: "/results",
    keywords: [
