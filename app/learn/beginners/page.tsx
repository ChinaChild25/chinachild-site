...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Хаб «Китайский с нуля»: пиньинь, тоны, первые иероглифы, грамматика HSK 1, материалы и статьи. Реалистичный план для детей от 7 лет, подростков, студентов и взрослых.",
  ...
  return (
    <main>
      ...
      <PageHero
        ...
        description="Если вы только начинаете учить китайский, не пытайтесь сразу зубрить иероглифы. Сначала пиньинь и тоны — это фундамент. Здесь — пошаговый маршрут, статьи преподавателей и базовые термины. Подходит детям от 7 лет, подросткам, студентам и взрослым."
        primaryCta={{
