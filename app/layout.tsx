...
export const metadata: Metadata = {
  ...buildMetadata({
    ...
    description:
      "Онлайн-школа китайского ChinaChild: программа HSK 1–2, разговорный уровень за 6 месяцев, мини-группы до 5. Лицензия Москвы и документы для социального налогового вычета.",
    path: "/",
    keywords: [
