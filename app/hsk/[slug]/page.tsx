      ...
      <section className="page-shell-wide section-space">
        <div className="grid gap-5 md:grid-cols-3">
          <article className="card-block card-violet-soft">
            ...
            <div className="mt-2 text-[2.5rem] font-medium tracking-[-0.02em] text-[#262626] leading-[1.05]">
              {level.words}
            </div>
          ...
          <article className="card-block card-cream">
            ...
            <div className="mt-2 text-[1.75rem] font-medium tracking-[-0.02em] text-[#262626] leading-[1.1]">
              {level.hours}
            </div>
