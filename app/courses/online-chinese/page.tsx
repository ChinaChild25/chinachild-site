...
export async function generateMetadata(): Promise<Metadata> {
  return buildMetadata({
    ...
    description:
      "Онлайн-курсы китайского: мини-группы до 5 от 15 990 ₽, индивидуально и самостоятельно, носитель и русскоязычные преподаватели. Лицензия Москвы, вычет 13%.",
...
const whyCards = [
  ...
  },
  {
    ...
    body:
      "Документы для вычета оформляются онлайн. Вернёте 13% стоимости обучения — до 19 500 ₽ в год.",
  },
];

// ── Pillar-роутинг: выберите курс ─────────────────────────────────────────
const routes = [
  { tone: "card-violet-soft", title: "Школьникам 12+", body: "Программа HSK 1–2 для подростков, расписание под школу и подготовка к ОГЭ/ЕГЭ.", href: "/courses/chinese-for-kids" },
...
const formats = [
  ...
  { name: "Индивидуально", price: "17 990 ₽", who: "максимальный темп и гибкое расписание под вашу цель" },
];
  ...
  return (
    <CourseLanding
      ...
      pageHero={{
        ...
        description:
          "Лицензированная программа HSK 1–2 для подростков 12+ и взрослых: мини-группы до 5 человек, индивидуальные занятия и самостоятельный формат. Собственная платформа с записями уроков и AI-тренажёром — учиться можно из любого города.",
      }}
      sections={
        <>
          {/* === ПОЧЕМУ ОНЛАЙН ============================================== */}
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Самостоятельное «Введение» — 4 990 ₽ за 80 уроков, мини-группа до 5 человек — 15 990 ₽, индивидуально — 17 990 ₽ за 8 занятий. Со всех форматов можно вернуть 13% налогового вычета — до 19 500 ₽ в год.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "После пробного занятия и выбора формата вы получаете счёт и оплачиваете онлайн. Школа лицензирована департаментом Москвы — выдаём документы, по которым возвращается 13% налогового вычета.",
        },
        {
      ...
      schemaCourse={{
        ...
        priceValue: "4990",
        description:
          "Лицензированные онлайн-курсы китайского языка для подростков 12+ и взрослых. Программа HSK 1–2, собственная платформа с записями уроков и AI-тренажёром.",
