...
export async function generateMetadata(): Promise<Metadata> {
  return buildMetadata({
    ...
    description:
      "Курс китайского для школьников с 12 лет: программа HSK 1–2, индивидуально и в мини-группе, разговорный за полгода. Скидка 10% и налоговый вычет для родителя.",
...
const whyCards = [
  ...
  },
  {
    tone: "card-lime-soft",
    eyebrow: "Скидка 10%",
    title: "28 990 ₽ вместо 31 990 ₽",
    body:
      "Индивидуальный курс при оплате за 2 месяца — 28 990 ₽ со скидкой 10%. Стоимость закрепляется в договоре до старта.",
  },
  {
    tone: "card-sky",
    ...
    body:
      "Школа лицензирована Департаментом образования Москвы. Родитель возвращает 13% за обучение ребёнка — до 14 300 ₽ в год; документы выдаём.",
  },
];
...
const processSteps = [
  { step: "01", title: "Заявка и звонок", body: "Куратор перезванивает в рабочий день, уточняет возраст, цель и удобное время. Никаких автосписаний и подписок." },
...
// ── Форматы и цена ────────────────────────────────────────────────────────
const priceCards = [
  { tone: "card-cream-soft", title: "Индивидуально для школьника", price: "28 990 ₽", note: "вместо 31 990 ₽ — скидка 10% при оплате за 2 месяца", body: "Один на один с преподавателем: персональный темп, разбор ошибок и расписание под школу." },
    ...
    <CourseLanding
            ...
            <div className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr] lg:items-stretch">
              ...
              <div className="grid gap-4">
                ...
                <p className="text-sm leading-[1.55] text-[var(--muted-strong)]">
                  Родитель может вернуть 13% — налоговый вычет за обучение ребёнка
                  до 14 300 ₽ в год. Помогаем оформить документы.
                </p>
              </div>
            </div>
          </section>
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Индивидуальный курс по программе HSK 1–2 — 31 990 ₽ за два месяца, при оплате за 2 месяца действует скидка 10% — 28 990 ₽. Мини-группа до 5 человек — 15 990 ₽ за 8 занятий. Родитель может вернуть 13% налогового вычета за обучение ребёнка.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Да. Школа лицензирована Департаментом образования Москвы. Родитель может вернуть 13% от стоимости обучения ребёнка — до 14 300 ₽ в год (по лимиту расходов на обучение ребёнка). Документы для вычета выдаём.",
        },
        {
