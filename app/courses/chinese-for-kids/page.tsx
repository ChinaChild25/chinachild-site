...
export async function generateMetadata(): Promise<Metadata> {
  return buildMetadata({
    ...
    description:
      "Курс китайского для школьников строго с 12 лет: индивидуальный модуль от 17 990 ₽ за месяц, 8 занятий по 60 минут, и мини-группы. Налоговый вычет для родителя.",
    ...
    <CourseLanding
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Индивидуальный модуль для школьника 12+ — от 17 990 ₽ за один месяц: 8 занятий по 60 минут с русскоязычным преподавателем. Это базовая цена; при преподавателе-носителе или сжатых сроках стоимость выше. После него можно продолжить обучение, отдельно оплатив следующий модуль. Это не подписка и не рассрочка; автоматического списания и обязательной покупки следующих модулей нет. Мини-группа до 5 человек — 15 990 ₽ за 8 занятий.",
        },
        {
