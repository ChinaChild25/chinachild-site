...
const priceCards = [
  ...
  { tone: "card-lime-soft", title: "Индивидуально", price: "17 990 ₽", body: "Модуль на месяц: 8 занятий один на один по 60 минут. После него можно продолжить подготовку, отдельно оплатив следующий; автоматического списания нет." },
];
