...
const whyCards = [
  ...
  },
  {
    ...
    body:
      "При наличии права на социальный вычет можно вернуть до 19 500 ₽ за своё обучение или до 14 300 ₽ за обучение ребёнка. Сумма зависит от расходов и уплаченного НДФЛ.",
  },
];
...
const priceCards = [
  ...
  { tone: "card-lime-soft", title: "Индивидуально", price: "от 17 990 ₽", body: "Модуль на месяц: 8 занятий один на один по 60 минут. После него можно продолжить подготовку, отдельно оплатив следующий; автоматического списания нет." },
];
    ...
    <CourseLanding
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Мини-группа до 5 человек — 15 990 ₽. Индивидуальный модуль — от 17 990 ₽ за один месяц: 8 занятий по 60 минут с русскоязычным преподавателем уровня HSK 4+. Это базовая цена; при работе с преподавателем-носителем, сжатых сроках или особых целях стоимость выше. После него можно продолжить подготовку, отдельно оплатив следующий модуль. Это не подписка и не рассрочка; автоматического списания и обязательной покупки следующих модулей нет. Есть и самостоятельное «Введение» за 4 990 ₽.",
        },
        {
      ...
      individualModule={INDIVIDUAL_COURSE_MODULES.hsk}
