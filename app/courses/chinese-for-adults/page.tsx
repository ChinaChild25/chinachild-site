...
export async function generateMetadata(): Promise<Metadata> {
  return buildMetadata({
    ...
    description:
      "Курс китайского для взрослых с нуля: программа HSK 1–2, мини-группа от 15 990 ₽, носитель путунхуа, налоговый вычет 13%. Бесплатный пробный урок.",
...
const whyCards = [
  ...
  },
  {
    ...
    body:
      "Школа работает по образовательной лицензии Департамента образования Москвы. Вернёте 13% стоимости обучения — до 19 500 ₽ в год; документы для вычета выдаём.",
  },
];
...
const processSteps = [
  {
    ...
    body:
      "Оставляете заявку — куратор перезванивает в рабочий день. Уточняем цель, текущий уровень и удобное время. Никаких автосписаний и подписок.",
  },
  {
    step: "02",
...
const priceCards = [
  ...
  },
  {
    ...
    price: "17 990 ₽",
    body:
      "8 занятий один на один: персональный темп и расписание, преподаватель уровня HSK 4+ и сопровождение куратора на всём курсе.",
  },
];
    ...
    <CourseLanding
            ...
            <div className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr] lg:items-stretch">
              ...
              <div className="grid gap-4">
                ...
                <p className="text-sm leading-[1.55] text-[var(--muted-strong)]">
                  Со всех форматов можно вернуть 13% — налоговый вычет до 19 500 ₽
                  в год. Помогаем оформить документы.
                </p>
              </div>
            </div>
          </section>
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Самостоятельное «Введение» — 4 990 ₽ за 80 уроков, мини-группа — 15 990 ₽, индивидуально — 17 990 ₽ за 8 занятий. Школа лицензирована департаментом Москвы, поэтому можно вернуть налоговый вычет 13% — до 19 500 ₽ в год.",
        },
        {
