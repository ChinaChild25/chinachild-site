...
const processSteps = [
  { step: "01", title: "Заявка и аудит потребности", body: "Обсуждаем задачи команды, отрасль и желаемый результат. Готовим коммерческое предложение в течение рабочего дня." },
...
const paymentModels = [
  ...
  { tone: "card-lime-soft", title: "Сотрудник платит сам", body: "Сотрудник оформляет обучение на себя и возвращает 13% налогового вычета — до 19 500 ₽ в год." },
];
    ...
    <CourseLanding
              ...
              <Reveal>
                <div className="card-block card-block-lg card-ink h-full">
                  ...
                  <p className="mt-5 text-base leading-7 text-white/85">
                    ...
                    отраслевых модулей. Оставьте заявку — пришлём коммерческое
                    предложение в течение рабочего дня, с прозрачной разбивкой и
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            "Стоимость рассчитывается под размер команды, формат групп и набор отраслевых модулей. Оставьте заявку — пришлём коммерческое предложение в течение рабочего дня с прозрачной разбивкой.",
        },
        {
      ...
      ctaText="Оставьте заявку — обсудим задачи, протестируем уровень сотрудников и пришлём расчёт с закрывающими документами в течение рабочего дня. Можно начать с демо-урока для команды."
      related={[
