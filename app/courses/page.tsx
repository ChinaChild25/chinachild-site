...
export async function generateMetadata(): Promise<Metadata> {
  return buildMetadata({
    ...
    description:
      "Все курсы китайского онлайн в ChinaChild: HSK 1–6, для детей от 7 лет, подростков, студентов, взрослых и бизнеса. Налоговый вычет: до 19 500 ₽ за себя или до 14 300 ₽ за ребёнка.",
    path: "/courses",
    keywords: [
...
const courses = [
  {
    ...
    description:
      "Лицензированная программа HSK 1–2 для детей от 7 лет, подростков, студентов и взрослых. Мини-группы до 5 человек или индивидуально.",
  ...
  },
  {
    ...
    description:
      "Индивидуальный модуль для детей от 7 лет и подростков: от 17 990 ₽ за месяц и 8 занятий по 60 минут. Продолжение — отдельным модулем по решению ученика.",
...
const coursesCardMediaOverride: Record<string, CourseMedia> = {
  "chinese-for-kids": {
    ...
    alt: "Курс китайского языка для детей от 7 лет в ChinaChild",
    width: 2000,
    height: 3000,
  },
};
        ...
        <div className="card-block card-block-lg card-cream">
          ...
          <div className="mt-6 grid gap-3 text-base leading-[1.55] text-[#4b4b4b]">
            <p>
              ...
              уровень за 6 месяцев. Если ребёнку от 7 лет — доступен адаптированный по возрасту
              индивидуальный модуль: от 17 990 ₽ за месяц и 8 занятий по 60 минут,
