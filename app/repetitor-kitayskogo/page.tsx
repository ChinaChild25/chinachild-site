...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Репетитор китайского онлайн: индивидуально с нуля до HSK 6, преподаватели ЮФУ и ДГТУ, носители путунхуа. Лицензия Москвы и документы для социального налогового вычета.",
...
const faqs = [
  {
    ...
    answer:
      "Индивидуальный модуль — от 17 990 ₽ за месяц: 8 занятий по 60 минут один на один с русскоязычным преподавателем. Это базовая цена подготовки к HSK; при работе с преподавателем-носителем, сжатых сроках или особых целях стоимость выше. Точные цены и пакеты — на странице «Цены»; стоимость закрепляется в договоре до начала курса.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Школа работает по образовательной лицензии Департамента образования и науки города Москвы и выдаёт документы для вычета. При наличии права можно вернуть до 19 500 ₽ за своё обучение или до 14 300 ₽ за обучение ребёнка; сумма зависит от расходов и уплаченного НДФЛ.",
  },
  {
...
const pageSchema = createPageGraph({
  ...
  description:
    "Индивидуальные занятия китайским с репетитором онлайн: с нуля до HSK 6, лицензия Москвы и документы для социального налогового вычета.",
  breadcrumbs,
  faqs,
  speakable: true,
});
...
const audience = [
  {
    ...
    body:
      "Дети от 7 лет и подростки, которые учат китайский для поступления, олимпиад или второго иностранного. Для них доступен отдельный модуль на месяц: 8 занятий по 60 минут за 17 990 ₽. Следующий модуль оплачивается отдельно, автоматического списания нет; родителям — отчёт о прогрессе раз в 4 урока.",
  },
  {
...
const processSteps = [
  {
    ...
    body:
      "Вы оставляете заявку — ежедневно с 09:00 до 21:00 МСК обычно отвечаем в течение 1–2 часов. Уточняем цель, уровень и время пробного занятия. Никаких автосписаний или подписок.",
  },
  {
    step: "02",
  ...
  return (
    <main>
      ...
      <PageHero
        ...
        description="Индивидуальные занятия китайским с преподавателями ЮФУ, ДГТУ и носителями путунхуа. С нуля до HSK 6, лицензия Москвы, документы для социального налогового вычета и собственная платформа без Zoom."
          ...
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div>
              ...
              <p className="mt-5 text-base leading-[1.65] text-[var(--muted-strong)]">
                ...
                опытом 5–10 лет, а также носители путунхуа из Китая.
                Куратор подбирает преподавателя под цель и характер ученика —
                если не сложится, поменяем без вопросов.
              </p>
      ...
      <FAQSection
        ...
        description="Если не нашли свой вопрос — напишите. Заявки обрабатываем ежедневно с 09:00 до 21:00 МСК, обычно отвечаем в течение 1–2 часов в этот период."
        schema={false}
