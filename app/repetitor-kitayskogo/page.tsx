...
const audience = [
  {
    badge: "Школьникам 12+",
    body:
      "Школьники строго с 12 лет, которые учат китайский для поступления, олимпиад или второго иностранного. Для них доступен отдельный модуль на месяц: 8 занятий по 60 минут за 17 990 ₽. Следующий модуль оплачивается отдельно, автоматического списания нет; родителям — отчёт о прогрессе раз в 4 урока.",
  },
  {
