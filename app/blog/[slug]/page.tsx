    ...
    <main>
      ...
      <article className="page-shell section-space pt-10">
        <header className="mx-auto max-w-3xl">
          ...
          <h1 className="mt-6 text-[2rem] font-medium leading-[1.1] tracking-[-0.025em] text-[#1e1e1e] sm:text-[2.6rem]">
            {post.title}
          </h1>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4 border-t border-[rgba(0,0,0,0.06)] pt-6">
            ...
            <div className="flex flex-col gap-0.5 text-sm">
              <span className="font-medium text-[#1e1e1e]">{author.name}</span>
