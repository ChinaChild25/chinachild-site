...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Семиминутная AI-диагностика построит ваш персональный портрет владения китайским: уровень HSK, сильные и слабые стороны, время до беглости. Реальный CAT-тест с адаптивной сложностью.",
  path: "/diagnostic",
  keywords: [
