...
export const INDIVIDUAL_COURSE_MODULES = {
  ...
  kids: {
    ...
    categoryId: "10023",
    name: "Индивидуальный модуль китайского для детей от 7 лет",
    feedName: "Китайский для детей от 7 лет: индивидуальный модуль",
    audience: "Дети от 7 лет и подростки",
    description:
      "Индивидуальный онлайн-модуль для ребёнка от 7 лет: 8 занятий по 60 минут за один месяц, с программой по возрасту и расписанием под школьную нагрузку.",
    classes: "1–11",
    stages: [
      {
        order: 1,
  ...
  hsk: {
    ...
    audience: "Дети от 7 лет, подростки, студенты и взрослые, готовящиеся к HSK",
    description:
