// Helpers that build deep-links into the authenticated platform (chinachild-sandbox).
// NEXT_PUBLIC_APP_URL points at the platform host (eg. https://app.chinachild.ru).
...
const DEFAULT_APP_URL = "https://app.chinachild.ru";
