...
export const cities: CityData[] = [
  {
    ...
    licensedRegion: true,
    hook:
      "Образовательная лицензия выдана Департаментом образования и науки города Москвы. При наличии права доступен социальный налоговый вычет по условиям ст. 219 НК РФ.",
    metaDescription:
      "Онлайн-курсы китайского в Москве: лицензия Москвы, HSK 1–2, мини-группы до 5. Вычет: до 19 500 ₽ за себя или до 14 300 ₽ за ребёнка.",
  },
  {
