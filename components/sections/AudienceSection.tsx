...
export default function AudienceSection() {
  return (
    <SectionShell
      id="dlya-kogo"
      title="Китайский под разные цели и возраст"
      description="Каждый сегмент ведёт на отдельную страницу с программой, ценами и ответами на популярные вопросы."
    >
